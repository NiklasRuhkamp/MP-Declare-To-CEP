...
// Registration and Execution of Response Constraints

public class ResponseStatementClass{

    public void startResponseStatement (EPServiceProvider epService, String responseActivationStatement, String responseTargetStatement, String reactToActivationStatement, String reactToFulfillmentStatement, String reactToTimeSpanViolationStatement){

        //Execute the EPL Query for Activaion
        epService.getEPAdministrator().createEPL(responseActivationStatement);

        //Execute the EPL Query for Target
        epService.getEPAdministrator().createEPL(responseTargetStatement);
